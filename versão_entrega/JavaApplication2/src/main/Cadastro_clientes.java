...
public class Cadastro_clientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nome_cliente_field.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                nome_cliente_fieldKeyTyped(evt);
            }
        });
        ...
        rpt_senha_cliente_field.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rpt_senha_cliente_fieldActionPerformed(evt);
            }
        });
        ...
        endereco_cliente_field1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                endereco_cliente_field1ActionPerformed(evt);
            }
        });
    ...
    if((endereco_cliente_field1.getText().trim().isEmpty() || endereco_cliente_field1.getText().equals("Endereço") || cpf_cliente.getText().trim().isEmpty() || cpf_cliente.getText().equals("Cpf"))){
        JOptionPane.showConfirmDialog(this, "Nenhum campo deve ficar em branco","Erro",JOptionPane.ERROR_MESSAGE);
    }
    
    else{
        if (!senha_cliente_field.getText().equals(rpt_senha_cliente_field.getText())){
            ...
            endereco_cliente_field1.setForeground(Color.gray);
            cpf_cliente.setForeground(Color.gray);
            int resposta = JOptionPane.showConfirmDialog(this, "Usuário cadastrado", "Confirmar", JOptionPane.YES_OPTION);
        }
    ...
    private void rpt_senha_cliente_fieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rpt_senha_cliente_fieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rpt_senha_cliente_fieldActionPerformed

    private void endereco_cliente_field1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_endereco_cliente_field1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_endereco_cliente_field1ActionPerformed

    private void cpf_clienteKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cpf_clienteKeyTyped
        char c = evt.getKeyChar();
        if(!(Character.isDigit(c))){
            evt.consume();
        }

    }//GEN-LAST:event_cpf_clienteKeyTyped

    private void nome_cliente_fieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nome_cliente_fieldKeyTyped
        char evt_char_nome = evt.getKeyChar();
        if(Character.isDigit(evt_char_nome)){
            evt.consume();
        }
    }//GEN-LAST:event_nome_cliente_fieldKeyTyped
